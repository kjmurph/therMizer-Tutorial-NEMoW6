...
# isimip_plankton_original <- read.table("therMizer-FishMIP-2022-HI/GFDL_resource_spectra_S1.03I0.85.dat")
isimip_plankton <- as(isimip_plankton, "matrix")
# isimip_plankton_original <- as(isimip_plankton_original, "matrix")
...
# head(isimip_plankton_original[1,])
# head(isimip_plankton[1,])
```
...
```{r}
paramsT <- upgradeTherParams(params, ocean_temp_array = ocean_temp_array,
